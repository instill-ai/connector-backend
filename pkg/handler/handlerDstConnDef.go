...
func (h *handler) ListDestinationConnectorDefinitions(ctx context.Context, req *connectorPB.ListDestinationConnectorDefinitionsRequest) (*connectorPB.ListDestinationConnectorDefinitionsResponse, error) {
