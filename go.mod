...
require (
	...
	github.com/instill-ai/component v0.5.0-alpha
	github.com/instill-ai/connector-ai v0.5.0-alpha
	github.com/instill-ai/connector-blockchain v0.5.0-alpha
	github.com/instill-ai/connector-data v0.5.0-alpha
