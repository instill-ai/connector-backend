...
require (
	...
	github.com/instill-ai/connector-ai v0.3.0-alpha.0.20230907065524-0cc19d751120
	github.com/instill-ai/connector-blockchain v0.3.0-alpha.0.20230906052339-fef2adb5bbbf
