...
export function CheckList() {
    ...
    group("Connector API: List destination connectors by admin", () => {
        ...
        check(http.request("GET", `${connectorHost}/v1alpha/admin/destination-connectors`), {
        ...
        var limitedRecords = http.request("GET", `${connectorHost}/v1alpha/admin/destination-connectors`)
        check(http.request("GET", `${connectorHost}/v1alpha/admin/destination-connectors?page_size=0`), {
        ...
        check(http.request("GET", `${connectorHost}/v1alpha/admin/destination-connectors?page_size=1`), {
        ...
        var pageRes = http.request("GET", `${connectorHost}/v1alpha/admin/destination-connectors?page_size=1`)
        check(http.request("GET", `${connectorHost}/v1alpha/admin/destination-connectors?page_size=1&page_token=${pageRes.json().next_page_token}`), {
        ...
        check(http.request("GET", `${connectorHost}/v1alpha/admin/destination-connectors?page_size=1&view=VIEW_BASIC`), {
        ...
        check(http.request("GET", `${connectorHost}/v1alpha/admin/destination-connectors?page_size=1&view=VIEW_FULL`), {
        ...
        check(http.request("GET", `${connectorHost}/v1alpha/admin/destination-connectors?page_size=${limitedRecords.json().total_size}`), {
...
export function CheckGet() {
    ...
    group("Connector API: Get destination connectors by ID by admin", () => {
        ...
        while (timeoutTime > currentTime) {
            var res = http.request("GET", `${connectorHost}/v1alpha/admin/destination-connectors/${resCSVDst.json().destination_connector.id}`)
        ...
        check(http.request("GET", `${connectorHost}/v1alpha/admin/destination-connectors/${resCSVDst.json().destination_connector.id}`), {
...
export function CheckLookUp() {
    ...
    group("Connector API: Look up destination connectors by UID by admin", () => {
        ...
        check(http.request("GET", `${connectorHost}/v1alpha/admin/destination-connectors/${resCSVDst.json().destination_connector.uid}/lookUp`), {
