...
export function CheckList() {
    ...
    group("Connector API: List destination connectors", () => {
        ...
        check(http.request("GET", `${connectorPublicHost}/v1alpha/${constant.namespace}/connector-resources?page_size=1&page_token=${pageRes.json().next_page_token}`), {
...
export function CheckConnect() {
    group("Connector API: Check Connect", () => {
        ...
        check(http.request("POST", `${connectorPublicHost}/v1alpha/${constant.namespace}/connector-resources/${resDstCsv.json().connector_resource.id}/connect`), {
        ...
        check(http.request("POST", `${connectorPublicHost}/v1alpha/${constant.namespace}/connector-resources/${resDstCsv.json().connector_resource.id}/disconnect`), {
        ...
        check(http.request("DELETE", `${connectorPublicHost}/v1alpha/${constant.namespace}/connector-resources/${resDstCsv.json().connector_resource.id}`), {
...
export function CheckState() {
    ...
    group("Connector API: Change state destination connectors", () => {
        ...
        check(http.request("POST", `${connectorPublicHost}/v1alpha/${constant.namespace}/connector-resources/${resCSVDst.json().connector_resource.id}/connect`, null, constant.params), {
        ...
        check(http.request("POST", `${connectorPublicHost}/v1alpha/${constant.namespace}/connector-resources/${resCSVDst.json().connector_resource.id}/disconnect`, null, constant.params), {
...
export function CheckTest() {
    ...
    group("Connector API: Test destination connectors by ID", () => {
        ...
        check(http.request("POST", `${connectorPublicHost}/v1alpha/${constant.namespace}/connector-resources/${resCSVDst.json().connector_resource.id}/testConnection`), {
