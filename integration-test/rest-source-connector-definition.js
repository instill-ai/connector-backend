...
export function CheckList() {
    ...
    group("Connector API: List source connector definitions", () => {
        ...
        check(http.request("GET", `${connectorPublicHost}/v1alpha/connector-definitions?page_size=0`), {
            ...
            "GET /v1alpha/connector-definitions?page_size=0 response all records": (r) => r.json().connector_definitions.length === limitedRecords.json().connector_definitions.length,
        });
