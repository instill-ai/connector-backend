...
export function CheckList() {
    ...
    group("Connector API: List source connector definitions", () => {
        ...
        check(http.request("GET", `${connectorPublicHost}/v1alpha/source-connector-definitions`), {
        ...
        var limitedRecords = http.request("GET", `${connectorPublicHost}/v1alpha/source-connector-definitions`)
        check(http.request("GET", `${connectorPublicHost}/v1alpha/source-connector-definitions?page_size=0`), {
        ...
        check(http.request("GET", `${connectorPublicHost}/v1alpha/source-connector-definitions?page_size=1`), {
        ...
        var pageRes = http.request("GET", `${connectorPublicHost}/v1alpha/source-connector-definitions?page_size=1`)
        check(http.request("GET", `${connectorPublicHost}/v1alpha/source-connector-definitions?page_size=1&page_token=${pageRes.json().next_page_token}`), {
        ...
        check(http.request("GET", `${connectorPublicHost}/v1alpha/source-connector-definitions?page_size=1&view=VIEW_BASIC`), {
        ...
        check(http.request("GET", `${connectorPublicHost}/v1alpha/source-connector-definitions?page_size=1&view=VIEW_FULL`), {
        ...
        check(http.request("GET", `${connectorPublicHost}/v1alpha/source-connector-definitions?page_size=${limitedRecords.json().total_size}`), {
...
export function CheckGet() {
    group("Connector API: Get source connector definition", () => {
        var allRes = http.request("GET", `${connectorPublicHost}/v1alpha/source-connector-definitions`)
        var def = allRes.json().source_connector_definitions[0]
        check(http.request("GET", `${connectorPublicHost}/v1alpha/source-connector-definitions/${def.id}`), {
        ...
        check(http.request("GET", `${connectorPublicHost}/v1alpha/source-connector-definitions/${def.id}?view=VIEW_BASIC`), {
        ...
        check(http.request("GET", `${connectorPublicHost}/v1alpha/source-connector-definitions/${def.id}?view=VIEW_FULL`), {
