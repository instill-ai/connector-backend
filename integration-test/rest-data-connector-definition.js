...
export function CheckList(header) {
    ...
    group("Connector API: List destination connector definitions", () => {
        ...
        check(http.request("GET", `${connectorPublicHost}/v1alpha/connector-definitions`, null, header), {
        ...
        var limitedRecords = http.request("GET", `${connectorPublicHost}/v1alpha/connector-definitions`, null, header)
        check(http.request("GET", `${connectorPublicHost}/v1alpha/connector-definitions?page_size=0`, null, header), {
        ...
        check(http.request("GET", `${connectorPublicHost}/v1alpha/connector-definitions?page_size=1`, null, header), {
        ...
        var pageRes = http.request("GET", `${connectorPublicHost}/v1alpha/connector-definitions?page_size=1`, null, header)
        check(http.request("GET", `${connectorPublicHost}/v1alpha/connector-definitions?page_size=1&page_token=${pageRes.json().next_page_token}`, null, header), {
        ...
        check(http.request("GET", `${connectorPublicHost}/v1alpha/connector-definitions?page_size=1&view=VIEW_BASIC`, null, header), {
        ...
        check(http.request("GET", `${connectorPublicHost}/v1alpha/connector-definitions?page_size=1&view=VIEW_FULL`, null, header), {
        ...
        check(http.request("GET", `${connectorPublicHost}/v1alpha/connector-definitions?page_size=${limitedRecords.json().total_size}`, null, header), {
...
export function CheckGet(header) {
    group("Connector API: Get destination connector definition", () => {
        var allRes = http.request("GET", `${connectorPublicHost}/v1alpha/connector-definitions`, null, header)
        var def = allRes.json().connector_definitions[0]
        check(http.request("GET", `${connectorPublicHost}/v1alpha/connector-definitions/${def.id}`, null, header), {
        ...
        check(http.request("GET", `${connectorPublicHost}/v1alpha/connector-definitions/${def.id}?view=VIEW_BASIC`, null, header), {
        ...
        check(http.request("GET", `${connectorPublicHost}/v1alpha/connector-definitions/${def.id}?view=VIEW_FULL`, null, header), {
